<template >
    ...
    <ul class="t-title">
        ...
        <li>
          <div class="products">歌手</div>
        </li>
        <li>
          <div class="products">专辑</div>
        </li>
        <li>
          <div class="products">时长</div>
        </li>
        <li>
      ...
      <ul class="s-list">
        <li class="adobe-product">
          <div class="products Music-name">
            <img src="@/static/img/歌单图标/3.jpg" alt="" />
            At The Edge (在边缘)
          </div>
          <span class="status">
            <span class="status-circle green"></span>
            千板</span>
          <span class="status alb"> 《At The Edge》</span>
