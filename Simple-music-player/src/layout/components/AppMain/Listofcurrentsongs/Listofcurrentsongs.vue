<template>
    ...
    <div class="content-section">
        ...
        <ul class="s-list">
            <li class="adobe-product" v-for="(item, index) in audiobox1" :key="item.id" @dblclick="playMusic(index)">
                <div class="products Music-name" :title="item.musicname">
                    <img :src="item.cover" alt="" />
                    {{ item.musicname }}
                </div>
                <span class="status alb" :title="item.singer">
                    <span class="status-circle green" ></span>
                    {{ item.singer }}</span>
                <span class="status alb" :title="item.al"> {{ item.al }}</span>
                <span class="status">{{ musicdt(item.dt) }} </span>

                <div class="button-wrapper">
                    <!-- 播放 -->
                    <svg @click="playMusic(index)" t="1648883741930" class="icon" viewBox="0 0 1024 1024" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" p-id="2199" width="32" height="32">
                        <path
                    ...
                    <!-- NV -->
                    <svg t="1648883775602" class="icon" viewBox="0 0 1024 1024" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" p-id="3156" width="48" height="48">
                        <path
                    ...
                    <svg t="1648883905939" class="icon" viewBox="0 0 1024 1024" version="1.1"
                        xmlns="http://www.w3.org/2000/svg" p-id="4298" width="37" height="37">
                        <path
...
const playMusic = (index: number) => {
    ...
    // console.log(store.getters.playi);
