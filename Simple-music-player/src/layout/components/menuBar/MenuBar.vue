<template>
    ...
    <div class="left-side">
        ...
        <div class="side-wrapper">
            ...
            <div class="side-menu">
                <a href="javascript:;" style="padding: 5px 10px 5px 10px;" v-for="(item, index) in userlist.value"
                    :key="index" @click="playlist(item.id)">
...
import { getuserlist } from '@/request/api.js'
