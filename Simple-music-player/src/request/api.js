...
// export const getMusicinfo = ()=>request.get("cloudsearch?keywords=海阔天空")
...
// 退出登录
export const outlogin = () => request.get("/logout")
// 获取账号信息
...
// 获取用户歌单
export const getuserlist = (data) => request.post("/user/playlist", data)
//每日歌单
